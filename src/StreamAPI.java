...
public class StreamAPI {
    public static void main(String[] args) {
        ...
        Course[] coursesArr = courses.stream()
                .filter(course -> course.getPrice() > 200000)
